...
//               {/* SHOW PLAY BUTTON WHEN hidePlayReel === false */}
//               {!hidePlayReel && (
//                 <div
//                   ref={playReelRef}
//                   className="flex items-center justify-center text-white text-8xl font-medium opacity-0"
//                 >
//                   <div className="flex items-center gap-4 group">
//                     <span>PLAY</span>
...
//               {/* SHOW VIRAT WHEN FULL VIDEO IS PLAYING */}
//               {isPlayingFullVideo && isFullVideo && (
//                 <div
//                   onClick={() => {
//                     setIsPlayingFullVideo(false);
//                     setHidePlayReel(false);
//                     setIsFullVideo(false);

//                     // ⭐ Force show PLAY button again
//                     gsap.to(playReelRef.current, {
//                       opacity: 1,
//                       duration: 0.4,
//                       ease: "power2.out",
//                     });
