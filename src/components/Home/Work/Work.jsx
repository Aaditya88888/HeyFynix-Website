...
//               ref={(el) => (slidesRef.current[i] = el)}
//               // className="slide flex-shrink-0 w-[95vw] h-[95vh] relative overflow-hidden"
//               className="slide flex-shrink-0 w-[95vw] h-[95vh] relative overflow-hidden pr-[1rem] pl-[1rem]"
//               onMouseEnter={handleEnter}
//               onMouseLeave={handleLeave}
//             >
//               <img
...
//       <div className="flex px-[4%] h-[50vh]">
//         <div className="left w-[40%] flex flex-col justify-between">
//           <h1 className="text-8xl h-[25%] whitespace-nowrap ">Our Portfolio</h1>

//           <div className="w-full h-[75%]  mt-26 z-[100]">
//             <img
...
//         <div className="center w-[30%] flex items-center justify-center text-center ">
//           <p className="text-2xl text-justify leading-[1.37]">
//             We're proud of the problems we've solved and the stories we've told.
//             Our portfolio reflects our commitment to excellence.
//           </p>
//         </div>
...
const Work = () => {
  ...
  return (
    <div className="overflow-x-hidden w-full h-full px-[4%] bg-transparent text-white mt-50">
      {/* Header */}
      ...
      <div className="flex h-[50vh]">
        <div className="left w-[45%] flex flex-col justify-between ">
          ...
          <div className="w-full h-[75%] mt-33 z-[100] ">
            <img
              ref={astronautRef}
              src="/images/home/astronaut.png"
              alt=""
        ...
        <div className="right w-[25%]  text-xl flex items-end justify-start">
          {/* <p className="-translate-x-10 transform">
            Here's a peek at what we've been up to:
          </p> */}
          <p className="leading-[119%] ">
        ...
        {imgs.map((src, i) => {
          ...
          return (
            <div
              key={src}
              ref={(el) => (slidesRef.current[i] = el)}
              className="slide flex-shrink-0 w-[90vw] h-[90vh] relative overflow-hidden"
              onMouseEnter={handleEnter}
              onMouseLeave={handleLeave}
            >
              <img
                src={src}
                alt={`Slide ${i}`}
                className="w-full h-full object-cover rounded-[1rem] select-none pointer-events-none"
                loading="lazy"
              />
            </div>
          );
