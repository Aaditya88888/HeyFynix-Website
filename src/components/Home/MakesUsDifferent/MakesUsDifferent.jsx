...
const MakesUsDifferent = () => {
  ...
  return (
    <>
      <div className="text-white bg-transparent text-section flex items-center justify-between px-[5%] pt-10 pb-0">
        <div className="right text-right max-w-lg">
          <p className="text-lg text-left">
            Excited yet? This is how we make sure every project feels like it
            was made just for you.
          </p>
        </div>
        <div className="left text-left max-w-lg italic flex flex-col">
          <h1>
            <span className="text-3xl">Our </span>
            <span className="font-bold text-7xl">Why!!!</span>
          </h1>
          <div className="">
            <h3 className="text-4xl font-bold leading-[1]">
              Makes Us Different
            </h3>
          </div>
        </div>
