    ...
    const init = async () => {
      parcelRequire = (function (init) {
        ...
        function $pTw7$var$_createClass(Constructor, protoProps, staticProps) {
          ...
          if (staticProps)
            $pTw7$var$_defineProperties(Constructor, staticProps);
          return Constructor;
          ...
          (function () {
            function THREERoot(params) {
              ...
              var _params$container = params.container,
                ...
                firstTime =
                  _params$firstTime === void 0 ? 0 : _params$firstTime,
        ...
        function $IDtB$var$_createClass(Constructor, protoProps, staticProps) {
          ...
          if (staticProps)
            $IDtB$var$_defineProperties(Constructor, staticProps);
          return Constructor;
        }
            ...
            $IDtB$var$_createClass(Controller, [
              {
                ...
                value: function addData(data) {
                  ...
                  var _options$folder = options.folder,
                    folder =
                      _options$folder === void 0 ? this.gui : _options$folder,
                    ...
                    if (isColor) {
                      ...
                      if (range) {
                        ...
                        if (value < 1 && value >= 0) {
                          ...
                          var diff =
                            Math.pow(10, String(Math.floor(value)).length - 1) *
                            2;
                          guiRange = [value - diff, value + diff];
                        }
                      }

                      controller = folder.add.apply(
                        folder,
                        [datData, key].concat(
                          $IDtB$var$_toConsumableArray(guiRange)
                        )
                      );
                    }
        ...
        function $Zk$var$_createClass(Constructor, protoProps, staticProps) {
          if (protoProps)
            $Zk$var$_defineProperties(Constructor.prototype, protoProps);
        ...
        function $Zk$export$animate(fn) {
          ...
          var _options$begin = options.begin,
            ...
            easing =
              _options$easing === void 0 ? "easeInOutCubic" : _options$easing,
          ...
          (function () {
            function Animation(fn, options) {
              ...
              var _options$begin2 = options.begin,
                ...
                duration =
                  _options$duration2 === void 0 ? 500 : _options$duration2,
                _options$easing2 = options.easing,
                easing =
                  _options$easing2 === void 0
                    ? "easeInOutCubic"
                    : _options$easing2,
            ...
            $Zk$var$_createClass(Animation, [
              {
                ...
                value: function tick(timestamp) {
                  ...
                  var position = this.easingFunction(
                    time,
                    this.begin,
                    this.change,
                    this.duration
        ...
        function $a87C$var$_createClass(Constructor, protoProps, staticProps) {
          ...
          if (staticProps)
            $a87C$var$_defineProperties(Constructor, staticProps);
          return Constructor;
        }
        ...
        var $a87C$export$default =
          ...
          (function () {
            function ShootingStar() {
              ...
              var $puli$$interop$default =
                $parcel$interopDefault($puli$exports);
              ...
              root.addResizeCallback(function () {
                ...
                material.uniforms["resolution"].value =
                  $mrfc$export$default.resolution; // let scale
            ...
            $a87C$var$_createClass(ShootingStar, [
              {
                ...
                value: function setSize() {
                  this.rate = Math.min(
                    $mrfc$export$default.ratio >
                      $mrfc$export$default.initialRatio
              ...
              },
              {
                ...
                value: function update(timestamp) {
                  ...
                  $a87C$var$dataKeys.forEach(function (key) {
                    _this2.material.uniforms[key].value =
                      _this2.datUniformData[key];
                  });
                },
              },
              {
                ...
                value: function draw(_ref) {
                  ...
                  var x =
                    clientX * this.rate + $mrfc$export$default.clientHalfWidth;
                  var y =
                    $mrfc$export$default.clientHeight -
                    (clientY * this.rate +
                  ...
                  this.mouseI +=
                    $a87C$var$MOUSE_ATTRIBUTE_COUNT * $a87C$var$PER_MOUSE;
                },
              },
              {
                key: "start",
        ...
        function $vFOr$export$getTextCoordinate(option) {
          var text = option.text,
            ...
            letterSpacing =
              _option$letterSpacing === void 0 ? 0 : _option$letterSpacing,
        ...
        function $m6Ky$var$_createClass(Constructor, protoProps, staticProps) {
          if (protoProps)
            $m6Ky$var$_defineProperties(Constructor.prototype, protoProps);
          if (staticProps)
            $m6Ky$var$_defineProperties(Constructor, staticProps);
          return Constructor;
        }
        ...
        var $m6Ky$export$default =
          ...
          (function () {
            function Text() {
              ...
              var fontSize =
                $mrfc$export$default.clientWidth < 360
                  ? $m6Ky$var$FONT_SIZE_MIN
                  : $mrfc$export$default.clientWidth < 768
                  ? $m6Ky$var$FONT_SIZE_SP
                  : $m6Ky$var$FONT_SIZE;
              var letterSpacing =
                $mrfc$export$default.clientWidth < 768
                  ? $m6Ky$var$LETTER_SPACING_SP
                  : $m6Ky$var$LETTER_SPACING;
              var textNormalWidth =
                $m6Ky$var$TEXT.length +
                letterSpacing * ($m6Ky$var$TEXT.length - 1);
              ...
              this.datUniformData = controller.addUniformData(
                $m6Ky$var$uniformData,
                uniforms,
                {
                  folder: folder,
                }
              );
              var $eAJ8$$interop$default =
                $parcel$interopDefault($eAJ8$exports);
              var $UNYd$$interop$default =
                $parcel$interopDefault($UNYd$exports);
              var material = (this.material = new THREE.RawShaderMaterial({
                uniforms: uniforms,
        ...
        function $Focm$var$_createClass(Constructor, protoProps, staticProps) {
          ...
          if (staticProps)
            $Focm$var$_defineProperties(Constructor, staticProps);
          return Constructor;
        }
          ...
          (function () {
            function WebGL(_ref) {
              ...
              var canvas = _ref.canvas,
                ...
                container =
                  _ref$container === void 0 ? document.body : _ref$container;
              ...
              var initialClientHeight =
                ($mrfc$export$default.initialClientHeight =
                  container.clientHeight); // store.initialRatio = container.clientWidth / container.clientHeight
              ...
              },
              {
                ...
                value: function start() {
                  ...
                  var amplitude = Math.min(
                    Math.max($mrfc$export$default.clientWidth * 0.1, 100),
                    180
                  );
                  $Zk$export$animate(
                    function (progress) {
                ...
                value: function textStart() {
                  ...
                  $Zk$export$animate(
                    function (progress) {
                      ...
                      _this3.text.update(
                        progress - $mrfc$export$default.clientWidth * 0.08
                      );
                    },
                    {
