...
const galleries = [
  {
    ...
    text: 'An event video captures the highlights, emotions, and key moments of a special occasion, preserving memories and sharing the experience with a wider audience.',
    images: [
      { src: '/images/work/E2.png',        videoSrc: '/videos/video1.mp4', alt: 'Branding 1', leftText: 'Sunburn', rightText: 'Sunburn' },
      { src: '/images/work/E3.png',        videoSrc: '/videos/video1.mp4', alt: 'Branding 2', leftText: 'Bismil Intro Video', rightText: 'Bismil' },
      { src: '/images/work/E5.png',        videoSrc: '/videos/video1.mp4', alt: 'Branding 3', leftText: 'Hip Hop Event', rightText: 'Elements.ind' },
      { src: '/images/work/E4.png',        videoSrc: '/videos/video1.mp4', alt: 'Branding 4', leftText: 'Skybags', rightText: 'Sunburn' },
      { src: '/images/work/E1.png',        videoSrc: '/videos/video1.mp4', alt: 'Branding 5', leftText: 'Rendezvous', rightText: 'IIT Delhi' },
    ],
  },
  {
    id: 2,
    ...
    text: 'We craft films that amplify Brands heartbeat',
    images: [
      { src: '/images/work/Film-making1.png',videoSrc: '/videos/video1.mp4', alt: 'Film 1', leftText: '3D Ultrasound Device', rightText: 'Samsung' },
      { src: '/images/work/Film-making2.png', videoSrc: '/videos/video1.mp4',alt: 'Film 2', leftText: 'Shake It to Make It', rightText: 'Zomato' },
      { src: '/images/work/Film-making3.png',videoSrc: '/videos/video1.mp4', alt: 'Film 3', leftText: 'Mascot Tour', rightText: 'Hush Puppies' },
      { src: '/images/work/Film-making4.png',videoSrc: '/videos/video1.mp4', alt: 'Film 4', leftText: 'Jewellery Commercial', rightText: 'Sawaria Jewellers' },
      { src: '/images/work/Film-making5.png',videoSrc: '/videos/video1.mp4',alt: 'Film 5', leftText: 'Cricket ', rightText: 'DPPL' },
    ],
  },
  {
    id: 3,
    ...
    text: 'We make the in-between of B-rolls that matter',
    images: [
      { src: '/images/work/BRoll1.png', alt: 'Web 1',videoSrc: '/videos/video1.mp4', leftText: 'Setup', rightText: 'Ritik' },
      { src: '/images/work/BRoll2.png', alt: 'Web 2', videoSrc: '/videos/video1.mp4',leftText: 'Tattoo', rightText: 'Mascot Tattos' },
      { src: '/images/work/BRoll3.png', alt: 'Web 3',videoSrc: '/videos/video1.mp4', leftText: 'Website', rightText: 'Ritik' },
      { src: '/images/work/BRoll4.png', alt: 'Web 4',videoSrc: '/videos/video1.mp4', leftText: 'Saloon Commercial', rightText: 'Spacetech Interiors' },
      { src: '/images/work/BRoll5.png', alt: 'Web 5',videoSrc: '/videos/video1.mp4', leftText: 'Cricket', rightText: 'DPPL' },
      { src: '/images/work/BRoll6.png', alt: 'Web 6', videoSrc: '/videos/video1.mp4',leftText: 'Sunburn', rightText: 'Sunburn' },
    ],
  },
  {
    id: 4,
    ...
    text: 'We transform Corporate Videos and Events into engaging, trust-building stories',
    images: [
      { src: '/images/work/coorporate1.png', alt: 'Music 1',videoSrc: '/videos/video1.mp4', },
      { src: '/images/work/coorporate2.png', alt: 'Music 2',videoSrc: '/videos/video1.mp4', },
      { src: '/images/work/coorporate3.png', alt: 'Music 3',videoSrc: '/videos/video1.mp4', },
      { src: '/images/work/coorporate4.png', alt: 'Music 4',videoSrc: '/videos/video1.mp4', },
      { src: '/images/work/coorporate5.png', alt: 'Music 5',videoSrc: '/videos/video1.mp4', },
      { src: '/images/work/coorporate6.png', alt: 'Music 6',videoSrc: '/videos/video1.mp4', },
    ],
  },
];
...
const HorizontalGallery = ({ images }) => {
  ...
  // Helper to detect if src is likely a video (simple extension check)
      ...
      <div style={{ position: 'relative', padding: '3rem 80px', margin: '-2rem', overflow: 'hidden' }}>
        ...
        <div
          ...
          style={{
            ...
            left: '45px',
            top: '50%',
            transform: `translateY(-50%) ${isHovered === 'left' ? 'scale(0.9)' : 'scale(1)'}`,
            width: '30px',
            height: '30px',
            background: isHovered === 'left' ? 'white' : 'rgba(255,255,255,0.15)',
        ...
        <div
          ...
          style={{
            ...
            right: '40px',
            top: '50%',
            transform: `translateY(-50%) ${isHovered === 'right' ? 'scale(0.9)' : 'scale(1)'}`,
            width: '30px',
            height: '30px',
            background: isHovered === 'right' ? 'white' : 'rgba(255,255,255,0.15)',
            backdropFilter: 'blur(20px)',
            borderRadius: '50%',
            display: 'flex',
            alignItems: 'center',
  ...
  <div style={{
    ...
    <Image
      ...
      style={{
        ...
        transition: 'all 0.5s ease',
        filter: isHoveredImage ? 'grayscale(90%) brightness(1.1)' : 'brightness(1.1)',
      }}
    />
  </div>
